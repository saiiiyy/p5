...
const transform5 = new Transform({
  position: new Vector3(8.5, 12, 15.5),
...
const transform7 = new Transform({
  ...
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(2.773984670639038, 2.904609203338623, 1.000594139099121)
})
...
const transform8 = new Transform({
  position: new Vector3(1, 6, 2.5),
  rotation: new Quaternion(-6.433131378134633e-15, -0.6949041485786438, 8.283903696337802e-8, -0.7191024422645569),
  scale: new Vector3(3.6957693099975586, 3.796875, 1.0005933046340942)
})
...
script3.spawn(plainText, {"text":"PARTY inc.","font":"SF_Heavy","color":"#FFFFFF"}, createChannel(channelId, plainText, channelBus))
